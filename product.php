...
<html lang="zxx">
    ...
    <head>
        <title>Dream Gallery | Product Page</title>
...
?>
                                        <a class="nav-link"
                                            href="product.php?cid=<?php  echo $row['ID'];?>&&artname=<?php  echo $row['ArtType'];?>"><span
                                                class="span"><?php  echo $row['ArtType'];?></span></a> <?php } ?>
                                    </li>
                                                ...
                                                <div class="men-cart-pro">
                                                    <div class="inner-men-cart-pro">
                                                        <a href="single-product.php?pid=<?php  echo $row['apid'];?>"
                                                            class="link-product-add-cart"> View Details</a>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="product_price">
                                                                <h4>
                                                                    <button class="btn btn-success"><a
                                                                            href="art-enquiry.php?eid=<?php echo $row['apid'];?>"
                                                                            style="color:#fff">Add cart</a></button>
                                                                </h4>
                                                            </div>
                                                        </div>
