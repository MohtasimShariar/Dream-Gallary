...
?>
                                ...
                                <div class="title"> <a class="dropdown-item" href="manage-artist.php">Total Photo
                                        Seller</a>
                                </div>
                            </div>
                            <!--/.info-box-->
...
?>
                                <i class="fa fa-file"></i>
                                <div class="count"><?php echo $artcount;?></div>
                                <div class="title"> <a class="dropdown-item" href="manage-art-type.php">Total Photo
                                        Type</a></div>
                            </div>
                            <!--/.info-box-->
                        </div>
...
?>
                                ...
                                <div class="title"> <a class="dropdown-item" href="manage-art-product.php">Total
                                        Product</a></div>
                            </div>
                            <!--/.info-box-->
                        </div>
