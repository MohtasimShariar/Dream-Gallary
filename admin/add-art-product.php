...
<html lang="en">
    ...
    <head>
        ...
        <title>Add Photo | Dream Gallery</title>
        ...
        <section id="container" class="">
            ...
            <section id="main-content" style="color:#000">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Add Product Detail</h3>
                            <ol class="breadcrumb">
                            ...
                            <div class="col-lg-6">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Product Image1</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Product Image2</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Product Image3</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Product Image4</label>
                                            <div class="col-sm-10">
