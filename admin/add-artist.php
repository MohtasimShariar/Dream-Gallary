...
<html lang="en">
    ...
    <head>
        <title>Add Artist | Dream Gallery</title>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal " method="post" action=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" id="mobnum" maxlength="10" name="mobnum"
                                                    type="text" required="true" pattern="[0-9]+">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <textarea class="form-control" name="edudetails"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <textarea class="form-control" name="awarddetails"
                                                    required="true"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
